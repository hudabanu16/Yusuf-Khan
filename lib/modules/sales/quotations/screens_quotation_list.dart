    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
        ...
        builder: (context, primarySnap) {
          ...
          List<QueryDocumentSnapshot<Map<String, dynamic>>> sourceDocs = primaryDocs;
          ...
          if (primaryDocs.isEmpty && primarySnap.hasError) {
            ...
            return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                ...
                builder: (context, fallbackSnap) {
                  ...
                  if (fallbackDocs.isNotEmpty && _dynamicQuotationCollection != _fallbackCollection) {
          ...
          if (primaryDocs.isNotEmpty && _dynamicQuotationCollection != _primaryCollection) {
            WidgetsBinding.instance.addPostFrameCallback((_) {
        ...
        Expanded(
          child: filteredDocs.isEmpty
            ...
            itemBuilder: (context, index) {
              ...
              final quoteNumber = (data['quoteNumber'] ?? '-').toString();
              final customerName = (data['clientName'] ?? 'Unknown Customer').toString();
              ...
              final inquirySource = (data['inquirySource'] ?? '').toString();
                      ...
                      Wrap(
                        ...
                        children: [
                          ...
                          _InlineInfo(
                            ...
                            text: contactPerson.isEmpty ? 'No Contact' : contactPerson,
                          ),
